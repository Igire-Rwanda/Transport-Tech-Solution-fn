...
<button>Book here</button>
        ...
        <div className="container2">
            <div className="cont2">
            <h2 id="home-fix-header">Find schedule</h2> 
         <p id="home-fix-para">Quickly look up scheduled times for a specific bus stop, bus route or station</p>
       <form>
        <div className="input">
...
<div className="whole3">
    <div className="one">
  <p id="home-fix-para">Schedule and maps</p>
    </div>
    <div className="two">
      <p id="home-fix-para"> bus schedules</p>
    </div>
</div>

<div className="schedule">
    <h1 id="home-fix-header">Bus Schedule</h1>
